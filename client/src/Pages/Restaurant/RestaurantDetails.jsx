...
const RestaurantDetails = () => {
    ...
    useEffect(() => {
        console.log("resdata in RestaurantDetails useEffect:", resdata);
    ...
    }, [searchText, sortBy, isVeg, menuItems]);
    ...
    function handleDeleteMenuItem(menuItemId) {
        const confirmDelete = window.confirm("Are you sure you want to remove this MenuItem?");
        if (confirmDelete) {
                    ...
                    <div className="flex gap-6">
                        ...
                        <div className="flex flex-col items-start justify-between gap-2">
                            ...
                            <div className="text-xs">
                                {resdata?.cuisines?.flatMap((cuisineString) =>
                                    cuisineString.split(",").map((cuisine) => (
                                        <span
                                            key={cuisine.trim()} // Use trim() to remove extra spaces and ensure unique keys
