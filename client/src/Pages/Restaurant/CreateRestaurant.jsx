...
//     // Get all restaurants from Redux store
//     const allRestaurants = useSelector((state) => state.restaurant.restaurantData);
//     const [loading, setLoading] = useState(false);

//     useEffect(() => {
//         // Fetch restaurants if they are not already in the Redux store.
//         if (!allRestaurants || allRestaurants.length === 0) {
//             setLoading(true);
//             dispatch(getAllRestaurants()).then(() => setLoading(false));
//         }
...
//             return;
//         }
//         // Check for duplicate phone number, but exclude the current restaurant's number when editing.
//         const isDuplicatePhoneNumber = allRestaurants.some(
//             (restaurant) =>
//                 restaurant.phoneNumber === userInput.phoneNumber &&
//                 (dataToEdit ? restaurant._id !== dataToEdit._id : true) // Exclude current when editing
//         );

//         if (isDuplicatePhoneNumber) {
//             toast.error("A restaurant with this phone number already exists.");
//             return;
//         }
...
//         formData.append("openingHours", userInput.openingHours);
//         formData.append("closingHours", userInput.closingHours);
//         formData.append("promotions", userInput.promotions);
...
//                 }
//             } catch (error) {
//                 // Handle errors from updateRestaurant (e.g., server errors)
...
//     }
//     if (loading) {
//         return <div className="text-center mt-10">Loading restaurants...</div>; // Simple loader
//     }
